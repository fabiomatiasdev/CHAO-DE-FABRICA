-- Dados Iniciais de Seed para o Sistema de PCP
...
VALUES
(1, 1, 1, 15, 4.50), -- Camiseta: 15 min, R$ 4,50 costura/mão de obra
(2, 1, 2, 35, 12.00); -- Calça: 35 min, R$ 12,00
...
VALUES
(1, 1, 1, 0.8500), -- Camiseta usa 0.85m de Algodão
(1, 1, 5, 0.0500), -- Camiseta usa 0.05 carretéis de linha
(1, 2, 2, 1.2000), -- Calça usa 1.20m de Sarja
(1, 2, 3, 1.0000), -- Calça usa 1 Zíper
(1, 2, 4, 1.0000), -- Calça usa 1 Botão
(1, 2, 5, 0.1000); -- Calça usa 0.10 carretéis de linha
